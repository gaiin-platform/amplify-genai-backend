...
permissions_by_state_type = {
    ...
    "/assistant/agentcore/session/delete": {"delete": can_delete_assistant},
    "/assistant/openai/delete": {"delete": can_delete_assistant}, # TO BE DELETED
    "/assistant/openai/thread/delete": {"delete": can_delete_assistant}, # TO BE DELETED
