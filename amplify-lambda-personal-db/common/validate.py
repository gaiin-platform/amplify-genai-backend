...
create_schema = {
    ...
    "properties": {
        ...
        "schema": {
            "type": ["object", "null"],
            "description": "An optional schema for the item"
        },
        "tags": {
            "type": ["array", "null"],
            "items": {
            ...
            "description": "Optional tags associated with the item"
        },
        "related_to": {
            "type": ["string", "null"],
            "description": "Optional related item"
        },
        "data": {
            "type": "object",
            "description": "Optional data associated with the item",
            "default": {}
        }
    },
