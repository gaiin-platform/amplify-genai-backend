...
def request_killed(user, request_id):
    ...
    if not requests_table:
        print("REQUEST_STATE_DYNAMO_TABLE is not provided in the environment variables.")
        raise ValueError("REQUEST_STATE_DYNAMO_TABLE is not provided in the environment variables.")
