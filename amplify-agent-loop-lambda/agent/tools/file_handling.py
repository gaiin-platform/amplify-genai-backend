...
@register_tool(tags=["file_handling"])
def zip_files(output_zip_path: str, file_mapping: Dict[str, str] = None, directory: str = None):
    """
...
@register_tool(tags=["file_handling"])
def unzip_files(zip_path: str, extract_dir: str = None, extract_pattern: Optional[List[str]] = None):
    """
