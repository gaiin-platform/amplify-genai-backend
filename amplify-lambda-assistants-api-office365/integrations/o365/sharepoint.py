...
def handle_graph_error(response: requests.Response) -> None:
    ...
    raise SharePointError(f"Graph API error: {error_message} (Status: {response.status_code})")

def list_sites(current_user: str, search_query: Optional[str] = None, 
               top: int = 10, skip: int = 0, access_token: str = None) -> List[Dict]:
    """
...
def get_site_by_path(current_user: str, hostname: str, 
                     site_path: Optional[str] = None, access_token: str = None) -> Dict:
    """
...
def list_site_lists(current_user: str, site_id: str, 
                    top: int = 10, skip: int = 0, access_token: str = None) -> List[Dict]:
    """
...
def get_list_items(current_user: str, site_id: str, list_id: str, 
                   expand_fields: bool = True, top: int = 10, 
                   skip: int = 0, filter_query: Optional[str] = None, access_token: str = None) -> List[Dict]:
    """
...
def create_list_item(current_user: str, site_id: str, 
                     list_id: str, fields_dict: Dict, access_token: str = None) -> Dict:
    """
...
def update_list_item(current_user: str, site_id: str, 
                     list_id: str, item_id: str, 
                     fields_dict: Dict, access_token: str = None) -> Dict:
    """
...
def delete_list_item(current_user: str, site_id: str, 
                     list_id: str, item_id: str, access_token: str = None) -> Dict:
    """
...
def format_list(lst: Dict) -> Dict:
    ...
    return {
        ...
        'list': {
            ...
            'contentTypesEnabled': lst.get('list', {}).get('contentTypesEnabled', False),
