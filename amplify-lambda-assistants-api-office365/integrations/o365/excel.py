...
def handle_graph_error(response: requests.Response) -> None:
    ...
    raise ExcelError(f"Graph API error: {error_message} (Status: {response.status_code})")
...
def list_tables(current_user: str, item_id: str, 
                worksheet_name: Optional[str] = None, access_token: str = None) -> List[Dict]:
    """
...
def add_row_to_table(current_user: str, item_id: str, 
                     table_name: str, row_values: List[Any], access_token: str) -> Dict:
    """
...
def read_range(current_user: str, item_id: str, 
               worksheet_name: str, address: str, access_token: str) -> List[List[Any]]:
    """
...
def update_range(current_user: str, item_id: str, 
                worksheet_name: str, address: str, 
                values: List[List[Any]], access_token: str) -> Dict:
    """
...
def get_worksheet(current_user: str, item_id: str, worksheet_id: str, access_token: str) -> Dict:
...
def create_worksheet(current_user: str, item_id: str, name: str, access_token: str) -> Dict:
...
def delete_worksheet(current_user: str, item_id: str, worksheet_id: str, access_token: str) -> Dict:
...
def create_table(current_user: str, item_id: str, worksheet_id: str, address: str, has_headers: bool = True, access_token: str = None) -> Dict:
...
def delete_table(current_user: str, item_id: str, table_id: str, access_token: str) -> Dict:
...
def get_table_range(current_user: str, item_id: str, table_id: str, access_token: str) -> Dict:
...
def list_charts(current_user: str, item_id: str, worksheet_id: str, access_token: str) -> List[Dict]:
...
def get_chart(current_user: str, item_id: str, worksheet_id: str, chart_id: str, access_token: str) -> Dict:
...
def create_chart(current_user: str, item_id: str, worksheet_id: str, chart_type: str, source_range: str, seriesBy: str, title: str = "", access_token: str = None) -> Dict:
...
def delete_chart(current_user: str, item_id: str, worksheet_id: str, chart_id: str, access_token: str) -> Dict:
