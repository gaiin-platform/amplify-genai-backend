...
def handle_graph_error(response: requests.Response) -> None:
    ...
    raise PlannerError(f"Graph API error: {error_message} (Status: {response.status_code})")

def list_plans_in_group(current_user: str, group_id: str, access_token: str) -> List[Dict]:
    """
...
def list_buckets_in_plan(current_user: str, plan_id: str, access_token: str) -> List[Dict]:
    """
...
def list_tasks_in_plan(current_user: str, plan_id: str, 
                      include_details: bool = False, access_token: str = None) -> List[Dict]:
    """
...
def create_task(current_user: str, plan_id: str, bucket_id: str, 
                title: str, assignments: Optional[Dict] = None,
                due_date: Optional[str] = None,
                priority: Optional[int] = None, access_token: str = None) -> Dict:
    """
...
def update_task(current_user: str, task_id: str, e_tag: str, 
                update_fields: Dict, access_token: str = None) -> Dict:
    """
...
def delete_task(current_user: str, task_id: str, e_tag: str, access_token: str = None) -> Dict:
    """
