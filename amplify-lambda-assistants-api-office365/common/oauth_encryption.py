...
def decrypt_oauth_data(data):
    ...
    if not parameter_name:
        raise ValueError("The environment variable OAUTH_ENCRYPTION_PARAMETER is not set")
    ...
    try:
        ...
        print(f"Error during parameter retrieval or decryption for {parameter_name}: {str(e)}")
        return None