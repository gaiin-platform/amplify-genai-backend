...
permissions_by_state_type = {
    ...
    "/integrations/mcp/server/oauth/start": {
        "start_mcp_oauth": lambda for_user, with_data: True
    },
    "/integrations/mcp/server/oauth/exchange": {
        "mcp_oauth_exchange": lambda for_user, with_data: True
    },
