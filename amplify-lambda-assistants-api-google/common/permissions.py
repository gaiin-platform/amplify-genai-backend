...
permissions_by_state_type = {
    ...
    "/google/integrations/gmail/compose-and-send": {
        "compose_and_send_email": lambda for_user, with_data: True
    },
    "/google/integrations/gmail/compose-draft": {
        "compose_email_draft": lambda for_user, with_data: True
    },
    "/google/integrations/gmail/get-recent-messages": {
        "get_recent_messages": lambda for_user, with_data: True
    },
    "/google/integrations/gmail/search-messages": {
        "search_messages": lambda for_user, with_data: True
    },
    "/google/integrations/gmail/get-attachment-links": {
        "get_attachment_links": lambda for_user, with_data: True
    },
    "/google/integrations/gmail/get-attachment-content": {
        "get_attachment_content": lambda for_user, with_data: True
    },
    "/google/integrations/gmail/create-filter": {
        "create_filter": lambda for_user, with_data: True
    },
    "/google/integrations/gmail/create-label": {
        "create_label": lambda for_user, with_data: True
    },
    "/google/integrations/gmail/create-auto-filter-label-rule": {
        "create_auto_filter_label_rule": lambda for_user, with_data: True
    },
    "/google/integrations/gmail/get-messages-from-date": {
        "get_messages_from_date": lambda for_user, with_data: True
    },
    ...
    "/google/integrations/people/search-contacts": {
        "search_contacts": lambda for_user, with_data: True
    },
    ...
    "/google/integrations/people/update-contact": {
        "update_contact": lambda for_user, with_data: True
    },
    ...
    "/google/integrations/people/list-contact-groups": {
        "list_contact_groups": lambda for_user, with_data: True
    },

    "/google/integrations/people/create-contact-group": {
        "create_contact_group": lambda for_user, with_data: True
    },

    "/google/integrations/people/update-contact-group": {
        "update_contact_group": lambda for_user, with_data: True
    },

    "/google/integrations/people/delete-contact-group": {
        "delete_contact_group": lambda for_user, with_data: True
    },

    "/google/integrations/people/add-contacts-to-group": {
        "add_contacts_to_group": lambda for_user, with_data: True
    },
