...
def add_contacts_to_group(current_user, group_resource_name, contact_resource_names, access_token = None):
    service = get_people_service(current_user, access_token)
...
def remove_contacts_from_group(current_user, group_resource_name, contact_resource_names, access_token = None):
    service = get_people_service(current_user, access_token)
    return service.contactGroups().members().modify(
        resourceName=group_resource_name,
