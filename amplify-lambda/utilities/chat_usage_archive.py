...
@track_execution(operation_name="archive_items", account="system")
def archive_items(event, context):
        ...
        for start_date, end_date in date_ranges:
            ...
            for item in items:
                ...
                try:
                    ...
                    logger.info(
                        f"Archived and deleted item with PrimaryKey: {item['PrimaryKey']}"
                    )
                except Exception as e:
                    logger.error(
                        f"Error archiving or deleting item with PrimaryKey: {item['PrimaryKey']}. Exception: {e}"
                    )
    ...
    return {"statusCode": 200, "body": "Archiving completed successfully."}
